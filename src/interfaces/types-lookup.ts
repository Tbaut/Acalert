...
declare module '@polkadot/types/lookup' {
  ...
  /** @name ModuleIdleSchedulerModuleEvent (40) */
  ...
  /** @name KaruraRuntimeScheduledTasks (41) */
  ...
  interface NutsfinanceStableAssetEvent extends Enum {
    ...
    readonly type: 'CreatePool' | 'Minted' | 'TokenSwapped' | 'RedeemedProportion' | 'RedeemedSingle' | 'RedeemedMulti' | 'BalanceUpdated' | 'YieldCollected' | 'FeeCollected' | 'AModified' | 'FeeModified';
  }
  ...
  interface NutsfinanceStableAssetCall extends Enum {
    ...
    readonly type: 'CreatePool' | 'Mint' | 'Swap' | 'RedeemProportion' | 'RedeemSingle' | 'RedeemMulti' | 'ModifyA' | 'ModifyFees';
  }
  ...
  /** @name ModuleTransactionPaymentChargeTransactionPayment (597) */
  interface ModuleTransactionPaymentChargeTransactionPayment extends Compact<u128> {}

  /** @name ModuleEvmSetEvmOrigin (598) */
