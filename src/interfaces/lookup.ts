...
export default {
  ...
  /**
   * Lookup40: module_idle_scheduler::module::Event<T>
   **/
  ...
  /**
   * Lookup41: karura_runtime::ScheduledTasks
   **/
  ...
  /**
   * Lookup42: module_evm::EvmTask<karura_runtime::Runtime>
   **/
  ModuleEvmEvmTask: {
    _enum: {
      Schedule: {
  ...
  /**
   * Lookup43: karura_runtime::Runtime
   **/
  ...
  /**
   * Lookup597: module_transaction_payment::ChargeTransactionPayment<T>
   **/
  ModuleTransactionPaymentChargeTransactionPayment: 'Compact<u128>',
  /**
   * Lookup598: module_evm::SetEvmOrigin<T>
   **/
