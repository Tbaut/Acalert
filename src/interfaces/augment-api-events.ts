...
declare module '@polkadot/api-base/types/events' {
  interface AugmentedEvents<ApiType extends ApiTypes> {
    ...
    incentives: {
      ...
      SavingRewardRateUpdated: AugmentedEvent<ApiType, [pool: ModuleSupportIncentivesPoolId, rewardRatePerPeriod: u128], { pool: ModuleSupportIncentivesPoolId, rewardRatePerPeriod: u128 }>;
